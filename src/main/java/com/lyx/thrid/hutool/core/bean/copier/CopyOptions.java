...
public class CopyOptions implements Serializable {
	...
	protected TypeConverter converter = (type, value) -> {
		...
		if(ArrayUtil.contains(new String[]{"com.lyx.thrid.hutool.json.JSONObject", "com.lyx.thrid.hutool.json.JSONArray"}, name)){
